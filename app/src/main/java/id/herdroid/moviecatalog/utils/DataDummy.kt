...
object DataDummy {
    ...
    fun dummyMovies(): List<MovieEntity> {
        ...
        val dataMovies = ArrayList<MovieEntity>()

        dataMovies.add(MovieEntity(
                "1",
                ...
                "6 December 2014 ",
                "https://image.tmdb.org/t/p/w600_and_h900_bestv2/bAQ8O5Uw6FedtlCbJTutenzPVKd.jpg"))
        ...
        dataMovies.add(MovieEntity(
                ...
                "28 July 2012",
                "https://image.tmdb.org/t/p/w600_and_h900_bestv2/xLal6fXNtiJN6Zw6qk21xAtdOeN.jpg"))
        ...
        dataMovies.add(MovieEntity(
                ...
                "30 August 2019",
                "https://image.tmdb.org/t/p/w600_and_h900_bestv2/j73LuQcA21KvkVFcroWWMN8tTJv.jpg"))

        dataMovies.add(MovieEntity(
                "5",
                "Hello World",
                "Year 2027, The city of Kyoto has undergone tremendous advancement. Within the city lives Naomi Katagaki, an introvert and Ruri Ichigyou, a girl with a cold personality. Both shares love for reading books. Despite having similar interests, Naomi is afraid to approach Ruri due to her unfriendly nature. One day, as Naomi goes out for a walk, a crimson aurora pierces through the sky for a brief moment. Shortly after, he sees a three-legged crow and a mysterious man who reveals himself to be Naomi from 10 years in the future, explaining that he has come to change a tragic event that happens to Ruri shortly after they start dating. Naomi follows his future self's instructions and starts getting closer to Ruri, determined to save her. With the help of his future self, Naomi begins his preparations to save Ruri. Will he be able to change the future?.",
                "20 September 2019",
                "https://image.tmdb.org/t/p/w600_and_h900_bestv2/r6BWky420eJQ0KbtUTlY06ZzFwU.jpg"))
        ...
        dataMovies.add(MovieEntity(
                ...
                "7 August 2015",
                "https://image.tmdb.org/t/p/w600_and_h900_bestv2/1k6iwC4KaPvTBt1JuaqXy3noZRY.jpg"))
        ...
        dataMovies.add(MovieEntity(
                ...
                "25 September 2018",
                "https://image.tmdb.org/t/p/w600_and_h900_bestv2/hC4nTxdhXqFWzgqynGvvXVMiMNp.jpg"))
        return dataMovies
    }

    fun dummyTvShows(): List<TvShowEntity> {

        val dataTvShows = ArrayList<TvShowEntity>()

        dataTvShows.add(TvShowEntity(
            "1",
            ...
            "2020",
            "https://image.tmdb.org/t/p/w600_and_h900_bestv2/mnQkaU3K1ITREihPOdYyTCGUNJg.jpg"))
        ...
        dataTvShows.add(TvShowEntity(
            ...
            "2018",
            "https://image.tmdb.org/t/p/w600_and_h900_bestv2/cU4jHfo1Q9AEPnFqFqtuSA74gdi.jpg"))
        ...
        dataTvShows.add(TvShowEntity(
            ...
            "2019",
        "https://image.tmdb.org/t/p/w600_and_h900_bestv2/9qUEWpMird1gUHneWuTI7HupP05.jpg"))
        ...
        dataTvShows.add(TvShowEntity(
            ...
            "2020",
        "https://image.tmdb.org/t/p/w600_and_h900_bestv2/4rqyyM0R3a0EeSlEvdpxDKbjiKB.jpg"))
        ...
        dataTvShows.add(TvShowEntity(
            ...
            "2018",
            "https://image.tmdb.org/t/p/w600_and_h900_bestv2/8jq6xv5c1WK7KAPOXCsodm8eUxp.jpg"))
        ...
        dataTvShows.add(TvShowEntity(
            ...
            "2018",
            "https://image.tmdb.org/t/p/w600_and_h900_bestv2/zHgc9nTXiP77qoy14BO7WUFTwkp.jpg"))
        ...
        dataTvShows.add(TvShowEntity(
            ...
            "1986",
            "https://image.tmdb.org/t/p/w600_and_h900_bestv2/dhtiYYbob8saEUFWle3aWgVY28M.jpg"))
        return dataTvShows
    }
