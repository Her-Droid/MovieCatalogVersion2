...
class DataRepository private constructor(
    ...
    companion object {
        ...
        fun getInstance(remoteDataRepository: RemoteDataRepository, localDataSource: LocalDataSource, appExecutors: AppExecutors): DataRepository {
            return DataRepository(remoteDataRepository,localDataSource, appExecutors )
        }
    }
    ...
    override fun getAllMovies(): LiveData<Resource<PagedList<MovieEntity>>> {
        return object : NetworkBoundResource<PagedList<MovieEntity>, List<MovieEntity>>(appExecutors) {
            ...
            public override fun createCall(): MutableLiveData<ApiResponse<List<MovieEntity>?>> =
    ...
    override fun getAllTvShows(): LiveData<Resource<PagedList<TvShowEntity>>> {
        return object : NetworkBoundResource<PagedList<TvShowEntity>, List<TvShowEntity>>(appExecutors) {
            ...
            public override fun createCall(): MutableLiveData<ApiResponse<List<TvShowEntity>?>> =
